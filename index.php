...
<html lang="en">
    <head>
        ...
        <title>Royal Cafe Coffee Shop</title>
        ...
        <link rel="icon" type="image/x-icon" href="assets/images/logo.png"><!-- Title / Icon -->
    ...
    <body>
        ...
        <header class="header">
            <a href="#" class="logo">
                <img src="assets/images/logo.png" class="img-logo" alt="Royal Logo">
                <span class="logo-name">Royal<span style="color:#fff;">Cafe</span></span>
            </a>
            ...
            <div class="cart">
                ...
                <div class="customer-input-field" style="margin: 15px 0;">
                <p style="font-weight: 600; color: #8b5a2b; margin-bottom: 5px; font-size: 14px;">Customer Name:</p>
                <input type="text" id="cust-name" placeholder="Enter your name" style="width: 100%; padding: 10px; border: 1px solid #dcdcdc; border-radius: 5px; outline: none; box-sizing: border-box;">
                <!-- BUY BUTTON -->
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to <br/>Royal Cafe <br/>Coffee Shop,<br/></h3>
                <p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    <h3>Welcome to Royal Cafe!</h3>
                    <p>
                        At Royal Cafe Coffee Shop, we are passionate about coffee and believe that every cup tells a story. We are a cozy coffee shop located in the heart of the city, dedicated to providing an exceptional coffee experience to our customers. Our love for coffee has led us on a voyage of exploration and discovery, as we travel the world in search of the finest coffee beans, carefully roasted and brewed to perfection.
                    </p>
                    <p>
                        But coffee is not just a drink, it's an experience. Our warm and
                        inviting atmosphere at Royal is designed to be a haven
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="box">
                                ...
                                <p>
                                    "The coffee here is absolutely divine! The cozy atmosphere and friendly staff made my visit truly special. if you're looking for best latte in town, Royal Cafe Coffee Shop is the place to be."
                                </p>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/quote-img.png" alt="" class="quote">
                                <p>
                                    "My Favorite spot to hang out with freinds. The cold brew is incredible, and the snacks are always fresh. It's the perfect combination of great taste and a great vibe!."
                                </p>
                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <img src="assets/images/quote-img.png" alt="" class="quote">
                                <p>
                                    "A wonderful place to work or study. The backgound music is soothing, and the espresso always gives me the perfect energy boost. Highly recommended for all coffee lovers!"
                                </p>
        ...
        <section class="contact" id="contact">
            ...
            <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d54060.05244583162!2d75.61719262846931!3d32.264703864434254!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391c59434860d5dd%3A0x6a386121f158579d!2sPathankot%2C%20Punjab!5e0!3m2!1sen!2sin!4v1711824000000!5m2!1sen!2sin" 
                width="100%" 
                height="450" 
                style="border:0;" 
                allowfullscreen="" 
                ...
                <form name="contact" method="POST" action="https://www.instagram.com/k_a.n.a.v?utm_source=qr&igsh=MXRxMGU1aWR1azd1NA==">
        ...
        <section class="footer">
            <div class="footer-container">
                ...
                <div class="credit">
                    <hr /><br/>
                    <h2>Royal Cafe Coffee Shop © 2026 | All Rights Reserved.</h2>
                    <h2>Designed by <span>Kanav Sharma & Krishna</span></h2>
                </div>
            </div>
        </section>
